...
async function initDatabase() {
  try {
    await pool.query(`
      ...
      ALTER TABLE MASTER_USER ADD COLUMN IF NOT EXISTS MCU_ATTACHMENT_ID INTEGER;
      ALTER TABLE MASTER_USER ADD COLUMN IF NOT EXISTS MCU_VALID_FROM DATE;
      ALTER TABLE MASTER_USER ADD COLUMN IF NOT EXISTS MCU_VALID_TO DATE;
    `);
